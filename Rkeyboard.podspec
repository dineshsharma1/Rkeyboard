...
'you can easily add custom keyboard in your app. it is highly customisable'
  ...
  s.homepage         = 'https://github.com/dineshsharma1/Rkeyboard.git'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'dineshsharma1' => 'dinesh.sharma@ranosys.com' }
...
s.source_files = 'Rkeyboard/Classes/*.{xib,plist.swift}'
#'Classes/*.{h,m}'

   s.resource_bundles = {
     'Rkeyboard' => ['Rkeyboard/Classes/Media.xcassets/**/*.png']
   }
